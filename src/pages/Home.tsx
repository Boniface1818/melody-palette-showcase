      ...
      <main className="pt-24 pb-12 container mx-auto px-6">
        ...
        <Section delay={100}>
          <div className="glass-card mt-12 text-center max-w-2xl mx-auto">
            ...
            <h2 className="text-xl sm:text-2xl font-display font-bold mb-4">Welcome to My Musical World</h2>
            <p className="text-sm text-muted-foreground leading-relaxed mb-4">
              I'm Boniface Kagunda — a composer and arranger passionate about creating music
              that serves worship, unites voices, and glorifies God. From piano duos to full
              mass settings, every piece is crafted with devotion, precision, and a deep love
              for sacred music.
            </p>
