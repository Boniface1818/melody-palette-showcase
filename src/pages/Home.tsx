    ...
    <>
      ...
      <main className="pt-24 pb-12 container mx-auto px-6">
        ...
        <section className="min-h-[70vh] flex flex-col items-center justify-center text-center">
          ...
          <Section delay={150}>
            <p className="mt-6 text-lg sm:text-xl md:text-2xl text-muted-foreground font-body">
              <span>{typedText}</span>
          ...
          <Section delay={300}>
            <p
              className="mt-8 max-w-lg text-sm text-muted-foreground leading-relaxed mx-auto"
